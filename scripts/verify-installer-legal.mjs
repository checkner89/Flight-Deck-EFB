...
assert.match(agreement, /NOTHING IN THIS INSTALLER AGREEMENT REMOVES, REDUCES OR CONTRADICTS/i);
...
assert.match(thirdParty, /Flight Deck EFB 1\.7\.5/);
assert.match(privacy, /version 1\.7\.5/);
