...
const [pkgSource, electronMain, materializer, releaseOrchestrator, finalReleaseWrapper, recoveryReleaseWrapper] = await Promise.all([
...
if (prepareRelease.includes('prepare-release-1.24.10.mjs')) {
