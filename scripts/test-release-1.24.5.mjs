...
if (!['1.24.5', '1.24.6', '1.24.7', '1.24.8'].includes(pkg.version)) throw new Error(`Expected package version 1.24.5 through 1.24.8, got ${pkg.version}.`);
...
need(app, ['1.24.6', '1.24.7', '1.24.8'].includes(pkg.version) ? 'WINDOWS APP · v1.24.6' : 'WINDOWS APP · v1.24.5', 'Desktop build marker is missing.');
...
const cache = pkg.version === '1.24.8' ? 'flyxora-v1.24.8-taxi-vatsim-profile'
  ...
  : 'flyxora-v1.24.5-stale-process';
need(sw, cache, 'Service-worker cache marker is incorrect.');
