...
if (pkg.version !== '1.24.6') throw new Error(`Expected package version 1.24.6, got ${pkg.version}.`);
...
need(html, 'data-app-version="1.24.6"', 'HTML app version is not 1.24.6.');
need(sw, 'flyxora-v1.24.6-desktop-shell', 'Service worker cache is not bumped for 1.24.6.');
