...
if (!['1.24.0', '1.24.1'].includes(pkg.version)) throw new Error(`Expected package version 1.24.0 or 1.24.1, got ${pkg.version}.`);
...
need(sw, pkg.version === '1.24.1' ? 'flight-deck-efb-v1241-tracking-layout' : 'flight-deck-efb-v1240-flighttracking', `${pkg.version} service-worker cache is missing.`);
