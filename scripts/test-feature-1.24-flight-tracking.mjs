...
const versionParts = String(pkg.version || '0.0.0').split(/[.-]/).slice(0, 3).map((part) => Number.parseInt(part, 10) || 0);
const versionAtLeast = (major, minor, patch) => {
...
const modernTraffic = versionAtLeast(1, 24, 2);
