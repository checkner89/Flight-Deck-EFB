export declare enum EventFlag {
    ...
    EVENT_FLAG_FAST_REPEAT_TIMER = 1,// set event repeat timer to simulate fast repeat
    ...
    EVENT_FLAG_SLOW_REPEAT_TIMER = 2,// set event repeat timer to simulate slow repeat
